/**
 * /diagnostic/end-of-level/[levelSlug] — End-of-level diagnostic skeleton loader
 *
 * Next.js App Router: rendered while Server Component suspends.
 * Mirrors the structural layout of the end-of-level diagnostic page.
 * Identical structure to placement skeleton (same question + 4-option layout).
 *
