...
| 4 | Diagnostic System | 2/5 | In Progress|  |
...
**Verification:** 5/5 must-haves verified (03-VERIFICATION.md) + human UAT all green (6/6). Build + 77 tests pass. UAT fixes: hero hydration (05ff960), explainer content rendering (608a6cd).

Plans:
**Wave 1**

- [x] 03-01-PLAN.md — Schema migration (4 tables + RLS + current_level_id + trigger), Wave 0 tests, [BLOCKING] live push + French 1 seed

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 03-02-PLAN.md — Level page slice: /levels/french-1 with time estimates, parts counts, locked/unlocked cards (LESSON-04)
- [x] 03-03-PLAN.md — Lesson view + mark-complete slice: optimistic save via Server Action, progress restore (LESSON-02, LESSON-03)
...
- [x] 04-02-PLAN.md — Schema migration (3 tables + watermark + RLS + concurrency index) + [BLOCKING] live push + seed pools (DIAG-01/02/03)

**Wave 2** *(blocked on Wave 1)*

- [ ] 04-03-PLAN.md — Placement diagnostic slice: Server Actions (draw/grade/score/place/admin-unlock) + flow + UI components (DIAG-01)
